        ...
        <section class="wrapper site-min-height" >
            <section class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal tasi-form" id="sv" enctype="multipart/form-data"  method="post" action="<?php echo U('Album/pictureAdd');?>">
                        ...
                        <a href="<?php echo U('Album/albumList');?>" class="btn btn-danger">取消</a>
...
//            var img=$('#up_img').val();
//            $.ajax({
//                url: '__APP_PATH__/Album/albumUpload',
//                type: 'post',
//                dataType: 'json',
//                data: {
//                    img:img,

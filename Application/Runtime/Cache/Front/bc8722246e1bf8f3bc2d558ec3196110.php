                ...
                <div class="col-sm-8" style="height:100%;">
                    <section class="panel" style="height:100%;background:#000;color:#fff;">
                        <header class="panel-heading clearfix">
                            图片详情
                            <a  class="btn btn-primary" style="margin-right: 20px;float: right" href="<?php echo U('Album/pictureDelete',array('id'=>$pictureInfo['id'],'mokuai_id'=>$mokuai_id));?>" onclick="return confirm('确定要删除吗？') ">删除图片</a>
                            <!--<a  class="btn btn-primary" style="margin-right: 20px;float: right" href="<?php echo U('Album/pictureEdit','id='.$pictureInfo['id']);?>">修改备注</a>-->
                ...
                <div class="col-sm-4" style="height:100%;">
                    <section class="panel" style="height:100%;">
                        <div class="panel-body" style="height:100%;">
                            ...
                            <form enctype="multipart/form-data"  method="post" action="<?php echo U('Album/replyAdd');?>" class="clearfix">

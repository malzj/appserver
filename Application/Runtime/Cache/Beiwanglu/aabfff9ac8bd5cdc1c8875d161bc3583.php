...
<header class="header reset" style="background: #1c7ff4;">
    ...
    <section id="main-content">
        <section class="wrapper mt80">
            <form class="form-horizontal tasi-form" action="<?php echo U('Beiwanglu/beiwangluEdit','id='.$beiwangluInfo['id']);?>" method="post" enctype= "multipart/form-data">
                ...
                <div class="mt25">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control" type="hidden" name="id" value="<?php echo ($beiwangluInfo["id"]); ?>"  />
                            <input class="form-control" type="text" name="title" value="<?php echo ($beiwangluInfo["title"]); ?>"  />
                        </div>
                    </div>
                    <div class="textarea">
                        <textarea  name="content" style="width:100%;height:500px;" ><?php echo ($beiwangluInfo["content"]); ?></textarea>
                    </div>
